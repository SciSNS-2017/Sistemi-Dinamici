...
Il progetto è ospitato su GitHub al link \url{https://github.com/SciSNS-2017/Sistemi-Dinamici} dove si può trovare la sua versione più recente. Ogni suggerimento (errori, soluzioni di esercizi, contributi vari, ecc.) è sempre gradito e può essere segnalato creando una \emph{issue} su GitHub oppure contattando direttamente gli autori.
